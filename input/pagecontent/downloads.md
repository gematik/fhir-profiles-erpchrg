<div class="dragon">
    Die hier bereitgestellten Dateien sind als normativ zu betrachten, wenn nicht anders dargestellt. Downloads an anderer Stelle, wie <a href="https://simplifier.net/epa-medication">Simplifier</a>, dienen ausschließlich als Hilfestellung bei der Implementierung und sind daher nicht normativ. Für eine vollständige und korrekte Implementierung sind die offiziellen Spezifikationen und begleitenden Dokumentationen maßgeblich.
</div>
...
- [OpenAPI JSON des ePA Medication Service Servers]
- [OpenAPI YAML des ePA Medication Service Servers]
- [OpenAPI JSON des ePA Medication Service Clients]
- [OpenAPI YAML des ePA Medication Service Clients]
{% endcomment %}