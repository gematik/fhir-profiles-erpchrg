...
* ^url = "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERPCHRG_PR_Communication_ChargChangeReq"
* ^version = "1.0"
* ^status = #draft
* ^abstract = true
* basedOn 1..1
...
* meta.profile[+] = "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERPCHRG_PR_Communication_ChargChangeReq|1.0"
