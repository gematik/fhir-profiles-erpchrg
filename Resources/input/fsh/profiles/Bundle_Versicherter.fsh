Instance: 200e3c55-b154-4335-a0ec-65addd39a3b6
InstanceOf: Bundle
Usage: #example
...
* entry[=].resource = Inline-Instance-for-200e3c55-b154-4335-a0ec-65addd39a3b6-1
* entry[+].fullUrl = "https://prescriptionserver.telematik/Bundle/f548dde3-a319-486b-8624-6176ff41ad90"
* entry[=].resource = f548dde3-a319-486b-8624-6176ff41ad90
* entry[+].fullUrl = "https://prescriptionserver.telematik/Bundle/dffbfd6a-5712-4798-bdc8-07201eb77ab8"
* entry[=].resource = dffbfd6a-5712-4798-bdc8-07201eb77ab8


Instance: Inline-Instance-for-200e3c55-b154-4335-a0ec-65addd39a3b6-1
InstanceOf: Bundle
Usage: #inline
...
* entry[=].resource.address.line = "Berliner Stra�e 1"
...
* entry[=].resource.address.line.extension[=].valueString = "Berliner Stra�e"
...
* entry[=].resource.qualification[=].code.text = "Facharzt f�r Allgemeinmedizin"
...
* entry[=].resource.payor.display = "AOK Baden-W�rttemberg"
...
Instance: f548dde3-a319-486b-8624-6176ff41ad90
InstanceOf: Bundle
Usage: #inline
* meta.profile = "http://fhir.abda.de/eRezeptAbgabedaten/StructureDefinition/DAV-PKV-PR-ERP-AbgabedatenBundle|1.1"
* meta.tag[0].display = "Beispiel RezeptAbgabedatenPKV Bundle (FAM + Noctu + Rezept�nderung)"
* meta.tag[+].display = "ACHTUNG! Der fachlich korrekte Inhalt der Beispielinstanz kann nicht gew�hrleistet werden. Wir sind jederzeit dankbar f�r Hinweise auf Fehler oder f�r Verbesserungsvorschl�ge."
* type = #document
* identifier.system = "https://gematik.de/fhir/erp/NamingSystem/GEM_ERP_NS_PrescriptionId"
* identifier.value = "200.086.824.605.539.20"
...
* signature.onBehalf.reference = "https://erp.zentral.erp.splitdns.ti-dienste.de/Device/1"
* signature.sigFormat = #application/pkcs7-mime
* signature.data = "dGhpcyBibG9iIGlzIHNuaXBwZWQ="

Instance: dffbfd6a-5712-4798-bdc8-07201eb77ab8
InstanceOf: Bundle
Usage: #inline
...
* entry[=].resource.section.entry.reference = "Binary/PrescriptionDigest-160.123.456.789.123.58"
...
* entry[=].resource.id = "PrescriptionDigest-160.123.456.789.123.58"
